<?php
/**
 * Account Reports Controller
 * Handles accounting reports
 */
...
class AccountReportsController extends BaseController {
    ...
    public function update() {
        ...
        $report = [
            'id' => $id,
            'type' => $this->requestData['type'] ?? 'balance_sheet',
    ...
    /**
     * Delete report
     * DELETE /apps/account/reports/:id
     */
